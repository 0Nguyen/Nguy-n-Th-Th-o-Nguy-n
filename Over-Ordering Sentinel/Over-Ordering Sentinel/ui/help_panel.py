...
HELP_CONTENT = {
    "vi": {
        "workflow_title": "Luồng dùng app",
        "workflow_lines": [
            "1. Tải file Excel lên hoặc dùng file mẫu.",
        ...
        "auto_title": "Chuẩn hoá tự động hoạt động thế nào",
        "auto_lines": [
            ...
            "Nếu một cột trạng thái bị toàn `unknown`, hãy kiểm tra lại mapping hoặc cách ghi dữ liệu gốc.",
        ],
        "manual_title": "Khi nào cần nối cột và chuẩn hoá thủ công",
        "manual_lines": [
            ...
            "Ghi chú chuẩn hoá dữ liệu Excel thủ công: hãy sửa header, đồng nhất mã giá trị, bỏ merged cells ở vùng dữ liệu, rồi kiểm tra `Normalized data preview` trước khi chạy phân tích.",
        ],
        ...
        "tip": "Mẹo: với file đơn giản, chỉ cần kéo thả Excel là app thường tự nhận sheet, header và mapping khá tốt để chạy ngay.",
    },
    "en": {
        "workflow_title": "App workflow",
        "workflow_lines": [
            "1. Upload the Excel file or use a sample file.",
        ...
        "manual_title": "When to use manual mapping and normalization",
        "manual_lines": [
            ...
            "Manual Excel standardization note: update headers, unify coded values, remove merged cells in the data region, then check `Normalized data preview` before running analysis.",
        ],
